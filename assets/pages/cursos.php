        ...
        <div class="navbar">
            <div class="container">
                ...
                <ul>
                    ...
                    <li><a href="http://localhost/driver_labs/assets/pages/cursos.php" class="active">Cursos</a></li>
        ...
        <section id="courses-banner">
            <div class="overlay">
                ...
                <div class="container">
                    ...
                    <h1 class="titulo-g">Biblioteca de cursos</h1>
                    <p class="lead">Cursos práticos baseados na realidade das vias em Maputo, que são fáceis de entender e diretos ao ponto, SEM ENGANOS</p>
        ...
        <section id="curses">
            ...
            <div class="container flex-column">
                <div class="barra-lateral">
                    ...
                    <h1 class="titulo-g">Cursos projetados para todos</h1>
                </div>

                <div class="courses-grid">

                    <div class="course-card">
                        <img src="../img/curso-defensivo.PNG" alt="">

                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Direção Defensiva & Escola de Trânsito</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
                    ...
                    <div class="course-card">
                        ...
                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Educação para Motoristas Adolescentes</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
                    ...
                    <div class="course-card">
                        <img src="../img/curso-adulto.PNG" alt="">

                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Educação para Motoristas Adultos</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
                    ...
                    <div class="course-card">
                        <img src="../img/curso-maduros.jpg" alt="">

                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Aperfeiçoamento para Motoristas Maduros</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
                    ...
                    <div class="course-card">
                        <img src="../img/curso-pratico.jpg" alt="">

                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Testes Práticos para Exames de Direção</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
                    ...
                    <div class="course-card">
                        ...
                        <div class="course-content">
                            <span>Iniciante</span>
                            <h2 class="titulo-m">Registos de Condução Certificados pelo INNATER</h2>
                            <div class="info">
                                <span><i class="fa-solid fa-user"></i> 500k+</span>
                                <span><i class="fa-solid fa-star-half-stroke"></i> 4.9</span>
                            </div>
