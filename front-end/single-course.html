...
<head>
    ...
    <title>Driver Lab - Single Course</title>
</head>

<body id="single-course-page">
    ...
    <main>
        ...
        <section id="single_course_main_box">

            <div class="single_course_box">

                <div class="single_course_header">

                    <div>
                        <img src="../img/user.PNG" alt="Professor">
                        <p><span>Professor</span> <br> <b>Elon Brittz</b></p>
                    </div>

                    <div>
                        <p><span>Última atualização:</span> <br> <b>24 de julho de 2024</b></p>
                    </div>

                    <div>
                        <p><span>Análise</span> <br>
